...
import { ListType, ChangesInput, DeleteListInput } from '../../interfaces/interfaceList';
import { CHANGE_LIST_NAME, CREATE_LIST, DELETE_LIST, GET_LISTS } from './types/queriesTypesList';
